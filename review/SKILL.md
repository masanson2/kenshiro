...
Require `current_phase: REVIEW` and all tasks `DONE`. Write concise Italian Markdown containing only modified components, implemented tasks, executed validations, executed tests, and remaining risks. Never include reasoning, opinions, chain of thought, or unexecuted checks.
